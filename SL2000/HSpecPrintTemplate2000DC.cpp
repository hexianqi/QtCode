...
HSpecPrintTemplate2000DC::HSpecPrintTemplate2000DC(QObject *parent) :
    HSpecPrintTemplate(*new HSpecPrintTemplate2000DCPrivate, parent)
{
    init();
}

HSpecPrintTemplate2000DC::HSpecPrintTemplate2000DC(HSpecPrintTemplate2000DCPrivate &p, QObject *parent) :
    HSpecPrintTemplate(p, parent)
{
}

HSpecPrintTemplate2000DC::~HSpecPrintTemplate2000DC() = default;

QString HSpecPrintTemplate2000DC::typeName()
{
    return "HSpecPrintTemplate2000DC";
}
...
{
    Q_D(HSpecPrintTemplate2000DC);
    d->types = HCore::membership(QStringList() << "|产品信息2|" << "|环境信息|" << "|时间信息|" << "|光谱信息2|" << "|光度信息2|" << "|光合信息|" << "|色容差信息2|" << "|TM30信息|" << "|直流电信息|");
