...
void HDetailWidget2000::refreshWidget()
{
    ...
    ui->lineEdit_002->setText(d->testData->toString(("[色坐标]")));
    ui->lineEdit_003->setText(d->testData->toString(("[红色比]")));
    ui->lineEdit_004->setText(d->testData->toString(("[光谱光通量]")));
    ui->lineEdit_011->setText(d->testData->toString(("[峰值波长]")));
    ui->lineEdit_012->setText(d->testData->toString(("[色坐标uvp]")));
    ui->lineEdit_013->setText(d->testData->toString(("[绿色比]")));
    ui->lineEdit_014->setText(d->testData->toString(("[光功率]")));
    ui->lineEdit_021->setText(d->testData->toString(("[峰值带宽]")));
    ui->lineEdit_022->setText(d->testData->toString(("[Duv]")));
    ui->lineEdit_023->setText(d->testData->toString(("[蓝色比]")));
    ui->lineEdit_024->setText(d->testData->toString(("[色温]")));
    ui->lineEdit_031->setText(d->testData->toString(("[色纯度]")));
    ui->lineEdit_032->setText(d->testData->toString(("[显色指数]")));
    ui->lineEdit_033->setText(d->testData->toString(("[显色指数Rx]")));
}
