...
int HLearnGLFW::testLightMaps()
{
    ...
    lightingShader->addShaderFromSourceFile(HOpenGLShader::Vertex,     ":/glsl/light_maps.vert");
    lightingShader->addShaderFromSourceFile(HOpenGLShader::Fragment,   ":/glsl/light_maps.frag");
