...
int HLearnGLFW::testMaterials()
{
    ...
    lightingShader->addShaderFromSourceFile(HOpenGLShader::Vertex,     ":/glsl/materials.vert");
    lightingShader->addShaderFromSourceFile(HOpenGLShader::Fragment,   ":/glsl/materials.frag");
