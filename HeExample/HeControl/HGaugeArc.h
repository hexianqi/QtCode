...
class HGaugeArcPrivate;

class HGaugeArc : public HAnimationProgress
{
    Q_OBJECT
    Q_DECLARE_PRIVATE(HGaugeArc)
...
public:
    explicit HGaugeArc(QWidget *parent = nullptr);
    ~HGaugeArc() override;
...
protected:
    HGaugeArc(HGaugeArcPrivate &p, QWidget *parent = nullptr);
