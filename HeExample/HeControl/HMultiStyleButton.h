/***************************************************************************************************
**      2017-09-24  HMultiStyleButton 多样式超级按钮控件
...
class HMultiStyleButton : public QWidget
{
    Q_OBJECT
...
public:
    explicit HMultiStyleButton(QWidget *parent = nullptr);
    ~HMultiStyleButton() override;
...
protected:
    HMultiStyleButton(HMultiStyleButtonPrivate &p, QWidget *parent = nullptr);
...
protected:
    QScopedPointer<HMultiStyleButtonPrivate> d_ptr;
