...
HControlTester::HControlTester(QObject *parent) :
    QObject(parent)
{
    registerClass();
}

HControlTester::~HControlTester()
{
    qDebug() << __func__;
}

QTableView *HControlTester::multHeaderTableView()
{
...
QTableWidget *HControlTester::multHeaderTableWidget()
{
...
QWidget *HControlTester::createWidget(QString type, QWidget *parent)
{
    return HWidgetFactory::createWidget<QWidget>(type, parent);
}

void HControlTester::registerClass()
{
