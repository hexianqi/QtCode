...
QChartView *HTestPlugin::testCIE1931View()
{
    return new HCie1931ChartView();
}

QChartView *HTestPlugin::zoomChart()
{
...
QChartView *HTestPlugin::lineChart(QList<QPolygonF> polys)
{
...
QChartView *HTestPlugin::diffChart(const QPolygonF &p1, const QPolygonF &p2)
{
...
QChartView *HTestPlugin::vernierChart(const QPolygonF &p1, const QPolygonF &p2)
{
    auto points = p1.toList();
    auto chart = new QChart();
    auto line1 = new QLineSeries();
