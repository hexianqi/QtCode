...
void doInterp(QVector<double> xa, QVector<double> ya, QVector<double> za, HInterp2D::Interp2DType type, std::function<void(gsl_spline2d *, gsl_interp_accel *, gsl_interp_accel *)> func)
{
    auto t = toGsl(type);
