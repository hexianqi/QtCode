...
HGlobalInstance *theInstance = HGlobalInstance::instance();

HGlobalInstance::HGlobalInstance(QObject *parent)
    : QObject(parent), d_ptr(new HGlobalInstancePrivate)
{
...
HGlobalInstance::HGlobalInstance(HGlobalInstancePrivate &p, QObject *parent)
    : QObject(parent), d_ptr(&p)
{
    // 可能需要同样的初始化
}

HGlobalInstance::~HGlobalInstance()
{
}

void HGlobalInstance::initActionComment()
{
...
void HGlobalInstance::initErrorComment()
{
...
void HGlobalInstance::initDataFormatInfo()
{
...
void HGlobalInstance::initDataCaption()
{
...
void HGlobalInstance::initMimeType()
{
