#include "HTestSetWidget1000A_p.h"
#include "ui_HTestSetWidget1000A.h"
#include "HeController/IModel.h"
#include "HeData/ITestData.h"
#include "HePlugin/HPluginHelper.h"
#include <QtCore/QTimer>

HTestSetWidget1000A::HTestSetWidget1000A(QWidget *parent) :
    HAbstractTestSetWidget(*new HTestSetWidget1000APrivate, parent),
    ui(new Ui::HTestSetWidget1000A)
{
    ui->setupUi(this);
    init();
}

HTestSetWidget1000A::~HTestSetWidget1000A()
{
    delete ui;
}

QString HTestSetWidget1000A::typeName()
{
    return "HTestSetWidget1000A";
}

void HTestSetWidget1000A::handleAction(HActionType action)
{
...
bool HTestSetWidget1000A::setTestState(bool b)
{
    Q_D(HTestSetWidget1000A);
...
void HTestSetWidget1000A::on_doubleSpinBox_1_valueChanged(double value)
{
    Q_D(HTestSetWidget1000A);
...
void HTestSetWidget1000A::on_doubleSpinBox_2_valueChanged(double value)
{
    Q_D(HTestSetWidget1000A);
...
void HTestSetWidget1000A::on_doubleSpinBox_3_valueChanged(double value)
{
    Q_D(HTestSetWidget1000A);
...
void HTestSetWidget1000A::on_doubleSpinBox_4_valueChanged(double value)
{
    Q_D(HTestSetWidget1000A);
...
void HTestSetWidget1000A::on_checkBox_1_clicked(bool b)
{
    Q_D(HTestSetWidget1000A);
...
void HTestSetWidget1000A::on_checkBox_2_clicked(bool b)
{
    setSaveMode(b ? 2 : 0);
}

void HTestSetWidget1000A::on_comboBox_1_currentIndexChanged(int value)
{
...
bool HTestSetWidget1000A::adjustIntegralTime()
{
    Q_D(HTestSetWidget1000A);
...
bool HTestSetWidget1000A::adjustLuminousGears()
{
    Q_D(HTestSetWidget1000A);
