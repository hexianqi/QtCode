...
HMainWindow1000A::HMainWindow1000A(QWidget *parent, const HConstructionCallHelper &helper) :
    HAbstractMainWindow(*new HMainWindow1000APrivate(this), helper, parent)
{
}
