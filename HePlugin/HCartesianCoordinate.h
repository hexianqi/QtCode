...
public:
    ...
    static QLineF map(QLineF data, QRectF target, QRectF source);
    static QVector<QLineF> map(QVector<QLineF> data, QRectF target, QRectF source);
...
public:
    ...
    QLineF mapToPosition(QLineF value, QRectF logic);
    QVector<QLineF> mapToPosition(QVector<QLineF> value, QRectF logic);
    QRectF mapToPosition(QRectF value, QRectF logic);
